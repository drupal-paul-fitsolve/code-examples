<div class="promo-wrapper equal-height-container <?php (!empty($variables['display']->context['panel-node']->data->field_promo_wrapper_class['und'][0]['safe_value']) ?
  ...
  <?php if(!empty($content['intro'])): ?>
      <div class="leader-double column grid-24">
          <?php print $content['intro']; ?>
      </div>
  <?php endif; ?>

  <?php if(!empty($content['top'])): ?>
    <div class="grid-24 column  equal-height-container row">
