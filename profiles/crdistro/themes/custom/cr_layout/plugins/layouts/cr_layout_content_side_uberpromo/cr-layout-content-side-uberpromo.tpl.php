<div class="promo-wrapper <?php (!empty($variables['display']->context['panel-node']->data->field_promo_wrapper_class['und'][0]['safe_value']) ?
                                  print $variables['display']->context['panel-node']->data->field_promo_wrapper_class['und'][0]['safe_value'] : "" ); ?>">
  ...
  <?php if(!empty($content['top'])): ?>
    <div class="grid-24 equal-height-container row">
      <div class="column">
...
<div class="main-content">
  <div class="container-24 clearfix">
    <div class="grid-24">
      <div class="grid-18 narrow-no-equality alpha">
      ...
      <div class="grid-6 narrow-grid-24 narrow-no-equality omega row">
