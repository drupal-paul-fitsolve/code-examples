...
<code>rednoseday.com/themes/custom/rnd15/templates/block/block--nav.tpl.php</code>

# Leave the relevant styling or add the styling to:
<code>sass/components/_button-nav.scss</code>

# Duplicate the "rnd15.emailSignup.js" located here:
<code>rednoseday.com/modules/features/rnd15_site_menu/js/rnd15.emailSignup.js</code>
...
# Go to the rnd15_site_header_simple context and add the path of the page to add the simple nav

# Go to the rnd15_site_header context and add the path of the page to remove the main site header
...
For more info please go to http://confluence.comicrelief.com/display/rnd15Documentation/Kids+Nav