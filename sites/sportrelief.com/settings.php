 ...
 *
 */
$drupal_hash_salt = 'gjqNxnONJAFowCn5E28Js-92Qwlh_vKvLlswsRUTU2w';
 ...
 */
$conf['memcache_key_prefix'] = getenv('MEMCACHE_PREFIX') ?: 'sportrelief-jan';
...
if ($varnish_hosts = getenv('VARNISH_HOSTS')) {
  ...
  // Cross environment varnish settings
  $conf['varnish_version'] = 3;
  $conf['varnish_socket_timeout'] = 1000;
...
/**
 * Patch MySQL settings for better high concurrency transaction support: https://www.drupal.org/node/1650930
 */
...
/**
 * Configure New Relic for performance and other analytics monitoring
 */
cr_configure_newrelic();
...
switch (getenv('AH_SITE_ENVIRONMENT')) {
  case 'local':
    ...
    // Default password for vagrant / scratch environments        
   ...
   // );
    ...
    $conf['stage_file_proxy_origin'] = 'http://' . urlencode('review') . ':hav3al00k@http://jan-sr14-dev.sportrelief.com/';
    $conf['stage_file_proxy_use_imagecache_root'] = TRUE;

    // Google API Specific
    // See cr_event_map module
    $conf['cr_event_map_gapi_settings'] = serialize(array(
      'clientid' => '84990593678-lv36shtdccsclki39d5nja5vn555m2lc.apps.googleusercontent.com',
      'clientsecret' => 'vFKgBwCezLvbmTLahY3gjXTi',
      'apikey' => 'AIzaSyA0WTcIQGwBLJG3r_lrhBZNUaHLj6bwXRo',
    ));
    $conf['cr_event_map_kmls'] = serialize(array(array(
      'enabled' => 1,
      'name' => 'Frost Local Event Data',
      'parser' => 'cr_event_map_kml_parser_sr14',
      'tableid' => '1Yq5acBmfGV6VTJIr8eAAPrfb1pKtaqx5hZIvQVg',
      'url' => 'https://sr-dev-frost.comicrelief.com/search/event/export/maintype/run?limit=2000',
    )));
  ...
  case 'cam-development';
    ...
    // See cr_event_map module
    $conf['cr_event_map_gapi_settings'] = serialize(array(
      'clientid' => '84990593678.apps.googleusercontent.com',
      'clientsecret' => 'sJ6BxfJjJAKSQbF17gXXXPyu',
      'apikey' => 'AIzaSyA0WTcIQGwBLJG3r_lrhBZNUaHLj6bwXRo',
    ));
    $conf['cr_event_map_kmls'] = serialize(array(array(
      'enabled' => 1,
      'name' => 'Frost Dev Event Data',
      'parser' => 'cr_event_map_kml_parser_sr14',
      'tableid' => '19k847bRfakT34jjlGWfH16D5Bat0aSm-kMzC8k0',
      'url' => 'https://sr-dev-frost.comicrelief.com/search/event/export/maintype/run?limit=2000',
    )));
    // Map fetch cron time in minutes: 0 to disable
    $conf['cr_event_map_fetch_time'] = '0';
  ...
  case 'cam-staging':
    ...
    // See cr_event_map module
    $conf['cr_event_map_gapi_settings'] = serialize(array(
      'clientid' => '84990593678-gfege6ffn62ovq13shc02ehpa83oq7ue.apps.googleusercontent.com',
      'clientsecret' => 'DxwqLp2vPGM4V9jQ8YpClYmE',
      'apikey' => 'AIzaSyA0WTcIQGwBLJG3r_lrhBZNUaHLj6bwXRo',
    ));
    $conf['cr_event_map_kmls'] = serialize(array(array(
      'enabled' => 1,
      'name' => 'Frost Staging Event Data',
      'parser' => 'cr_event_map_kml_parser_sr14',
      'tableid' => '108Zi3bZj0pXbbf5gjpcvCqOd-Lgib9Y7yJDFzSw',
      'url' => 'http://sr-staging-frost.comicrelief.com/search/event/export/maintype/run?limit=2000',
    )));
    // Map fetch cron time in minutes: 0 to disable
    $conf['cr_event_map_fetch_time'] = '0';
  ...
  case 'uat':
  case 'cam-uat':
    // UAT talks to staging webservices.
    ...
    // See cr_event_map module
    $conf['cr_event_map_gapi_settings'] = serialize(array(
      'clientid' => '84990593678-btdn3k7l1v9nbodl9a12ce5n88nr394r.apps.googleusercontent.com',
      'clientsecret' => '3LLOoKxLgbbA_QEfsTP7NDgU',
      'apikey' => 'AIzaSyA0WTcIQGwBLJG3r_lrhBZNUaHLj6bwXRo',
    ));
    $conf['cr_event_map_kmls'] = serialize(array(array(
      'enabled' => 1,
      'name' => 'Frost UAT Event Data',
      'parser' => 'cr_event_map_kml_parser_sr14',
      'tableid' => '1imKSRK_gPvoRRaX7_-D0Yg1HNI7TioNcEA-dY34',
      'url' => 'http://sr-uat-frost.comicrelief.com/search/event/export/maintype/run?limit=2000',
    )));
    // Map fetch cron time in minutes: 0 to disable
    $conf['cr_event_map_fetch_time'] = '0';
  ...
  case 'cam-production':    
    ...
    // See cr_event_map module
    $conf['cr_event_map_gapi_settings'] = serialize(array(
      'clientid' => '84990593678-ce8rjfqmj2320nsul8e303re3tu2c6kc.apps.googleusercontent.com',
      'clientsecret' => 'dY60ZTDWrEtetw5PzvB-75-w',
      'apikey' => 'AIzaSyA0WTcIQGwBLJG3r_lrhBZNUaHLj6bwXRo',
    ));
    $conf['cr_event_map_kmls'] = serialize(array(array(
      'enabled' => 1,
      'name' => 'Frost Event Data',
      'parser' => 'cr_event_map_kml_parser_sr14',
      'tableid' => '1itpfoPL-x94HAG-s632tb41eLIal-FKtfyokDNQ',
      'url' => 'http://my.sportrelief.com/search/event/export/maintype/run?limit=2000',
    )));

    break;

  default:
    die('Unknown environment: ' . $_ENV['AH_SITE_ENVIRONMENT']);
}
 ...
 */
function cr_configure_newrelic() {
  // only set New Relic name (and populate request data for this site) if current
  // request is web-based, (i.e. not drush), and if it is not a local site
  $site_is_local = getenv('AH_SITE_ENVIRONMENT') === 'local';
  $server_name = isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : '';
  $is_web_request = !empty($server_name);

  if ($is_web_request && !$site_is_local) {
    if (extension_loaded('newrelic')) {
      newrelic_set_appname($server_name);
    }
  }
}
