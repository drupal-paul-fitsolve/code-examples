...
(function(w, parent){
  ...
  w.picturefill = function(parent) {
    ...
    for (var i = 0, il = ps.length; i < il; i++ ) {
      // PB: 12/8/14 - Is this element visible?
      var visibility = ps[i].currentStyle ? ps[i].currentStyle.display : getComputedStyle(ps[i], null).display;

      //if (ps[i].getAttribute('data-picture') !== null) {
      // PB: 12/8/14 - Only process visible spans
      if (ps[i].getAttribute('data-picture') !== null && visibility !== 'none') {
