...
http://wiki.comicrelief.com/wiki/sr16splash_Technical_Documentation#Site_Header

This feature provides the default functionality for the ESU block in the header.

It relies on the sr16splash site menu and hooks into the menu script to show and hide the ESU.
