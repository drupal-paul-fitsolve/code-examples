...
class sr16splashSiteMenuTemplates extends BeanPlugin {
 ...
 */
  public function form($bean, $form, &$form_state) {
    ...
    $form['#attached']['js'] = array(
      drupal_get_path('module', 'sr16splash_site_menu_templates') . '/js/sr16splash_site_menu_templates.js',
    );
 ...
 */
  public function view($bean, $content, $view_mode = 'default', $langcode = NULL) {
    ...
    _sr16splash_site_menu_templates_add_active_trail($menuTreeData);

    // Prepare the $menuTreeData array.
    $menu = array();
    $menu = _sr16splash_site_menu_templates_prepare_menu_vars($menuTreeData, $menu);
