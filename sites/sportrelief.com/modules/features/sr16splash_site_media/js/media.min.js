...
var mediaTrackVideo=function(b){if(dataLayer){var c=b.target.pluginApi,d=c.getVideoData(),d=d.video_id+":"+d.title,a=b.type;switch(b.type){case "play":b.target.playCount="undefined"===typeof b.target.playCount?0:b.target.playCount+1;0===b.target.playCount&&(a="playfirst");break;case "timeupdate":if(a=1.5>=c.getDuration()-c.getCurrentTime()?1:(Math.floor(c.getCurrentTime()/c.getDuration()*4)/4).toFixed(2),!c.lastP||a>c.lastP)c.lastP=a,a=100*a+"%";else return}dataLayer.push({event:"sr16splash.video",label:d,
