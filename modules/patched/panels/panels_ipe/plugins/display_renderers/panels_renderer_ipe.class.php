...
class panels_renderer_ipe extends panels_renderer_editor {
  ...
  function render_pane(&$pane) {
    ...
    /*
     * Apply pane classes if it's enabled
     */
    $pane_classes = '';
    if(function_exists('panels_grid_styles_pane_classes') & isset($pane->style['settings'])) {
      $pane_classes  = panels_grid_styles_pane_classes($pane->style['settings']);
      $output = str_replace($pane_classes, '', $output);
    }
    ...
    return "<div id=\"panels-ipe-paneid-{$pane->pid}\" class=\"panels-ipe-portlet-wrapper panels-ipe-portlet-marker ".$pane_classes."\">" . $output . "</div>";
  }
