(function ($) {
   ...
   *
   * - Sets up the rnd15_site_tabs produced markup to work with the History JS plug-in,
  ...
  Drupal.behaviors.rnd15Tabs = {
    ...
    attach: function (context, settings) {
      ...
      var _base = Drupal.behaviors.rnd15Tabs;

      // Handle settings
      var default_settings = Drupal.settings.rnd15Tabs ? Drupal.settings.rnd15Tabs : {};
      Drupal.settings.rnd15Tabs = $.extend(default_settings, _base.defaults);

      var _settings = Drupal.settings.rnd15Tabs;

      // Setup the Tabs, passing in the relevant context
      // Once ensures it runs once
      $(_settings.tabsWrapperClass, context).once('rnd15Tabs', _base.setupTabs);
    },
