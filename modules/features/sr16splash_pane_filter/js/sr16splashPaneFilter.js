(function ($) {
  ...
  /**
   * Behaviour for the sr16splash Pane Filter
   *
  ...
  Drupal.behaviors.sr16splashPaneFilter = {
    ...
    attach: function (context, settings) {
      ...
      var _base = Drupal.behaviors.sr16splashPaneFilter;

      var default_settings = Drupal.settings.sr16splashPaneFilter ? Drupal.settings.sr16splashPaneFilter : {};
      Drupal.settings.sr16splashPaneFilter = $.extend(default_settings, _base.defaults);

      var _settings = Drupal.settings.sr16splashPaneFilter;
      ...
      $(_settings.sectionWrapperClass, context).once('sr16splashPaneFilter', _base.init);
    },
