...
http://confluence.comicrelief.com/display/sr16splashDocumentation/sr16splash+Site+Media

Video Panes Editor Documentation:
http://confluence.comicrelief.com/display/sr16splashEditorDocumentation/How+to+add+a+Video+Pane

Video Pages Editor Documentation:
http://confluence.comicrelief.com/display/sr16splashEditorDocumentation/How+to+add+a+Video+Page

Inline Video Row Editor Documentation:
http://confluence.comicrelief.com/display/sr16splashEditorDocumentation/How+to+add+an+Inline+Video+Row

GTM Tracking for Videos documented here:
http://confluence.comicrelief.com/display/sr16splashEditorDocumentation/GTM+Event+Tracking
...
The Video Panes are handled via the sr16splash Site Panes feature and the pages are handled separately in the sr16splash Site Media Video feature.

===== GTM Tracking =====
Several events are fired and pushed to the dataLayer listed below. For further information, please refer to the media.js file or the confluence documentation here: http://confluence.comicrelief.com/display/sr16splashEditorDocumentation/GTM+Event+Tracking
