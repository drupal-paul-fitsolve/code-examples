...
/**
 * @file
 * Describe hooks provided by the sr16splash Panel Transitions Module.
 */

/**
 *
 * Describe hook_sr16splash_panel_transitions_style_settings.
 *
 ...
 * auto-loaded.
 * 
 * Eg. function mymodule_sr16splash_panel_transitions_style_settings(style_settings){
 *   ...
 * }
 *
 * @return
 ...
 * 
 * function sr16splash_panel_transitions_rotate_sr16splash_panel_transitions_style_settings($style_settings){
 *
 *   $form = array();
 *
 *     $form['rotate'] = array(
 ...
 * 'sr16splash_panel_transitions_settings_form' module so hook implementations can be gathered in one place.
 *
 *   // Plugin definition
 *   $plugin = array(
 ...
 *    // Uses the setting form from sr16splash_panel_transitions so other
 *    // modules can implement the sr16splash_panel_transitions hooks.
 *    'settings form' => 'sr16splash_panel_transitions_settings_form',
 *    // The plugin can have it's own validation function.
 *    'settings form validate' => 'sr16splash_panel_transitions_flip_settings_form_validate',
 *  );
 *
 *  2: Implement hook_sr16splash_panel_transitions_prepare_vars().
 *
 *  All plugins invoke this hook to ensure their default Transition variables are added to use in their
 *  layout.tpl.php file.
 *
 *  The following is an example from sr16splash_panel_transitions_flip module.
 *  
 *  ----------------
 *  
 *  Ensure $transition_attributes and the $cta (if applicable) are available to all Transition plugins.
 * 
 *  function sr16splash_panel_transitions_flip_sr16splash_panel_transitions_prepare_vars($vars){
 *
